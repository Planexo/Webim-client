...
var MyGL = function () {
	...
	self.initGL = function (divContainer) {
		...
		width = document.getElementsByClassName("container")[2].offsetWidth;
		height = width*9/16;
		...
		_camera = new THREE.PerspectiveCamera(75, width / height, 1, 1000);
	...
	var onWindowResize = function () {
		var ratio = 16/9;
		var width = document.getElementsByClassName("container")[2].offsetWidth;
		_camera.aspect = ratio;
		_camera.updateProjectionMatrix();
		_renderer.setSize(width,width/ratio);
	};
